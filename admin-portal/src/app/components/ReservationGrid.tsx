...
export default function ReservationGrid() {
    ...
    const testData = [
        ...
        const [data, setData] = useState([{'id': '', 'name': '', 'description': '', 'alias': '', 'status': '', 'category': ''}]);
        ...
        const fetchData = async () => {
          try {
            const response = await fetch('http://localhost:8080/assets?type=Asset'); // Replace with your API endpoint
             ...
             <td className="size-px whitespace-nowrap">
                    ...
                    <td className="size-px whitespace-nowrap">
                      <div className="ps-6 lg:ps-3 xl:ps-0 pe-6 py-3">
                        <div className="flex items-center gap-x-3">
                          ...
                          <div className="grow">
                            <span className="block text-sm font-semibold text-gray-800 dark:text-neutral-200">{item.name}</span>
                    ...
                    <td className="h-px w-72 whitespace-nowrap">
                      <div className="px-6 py-3">
                        ...
                        <span className="block text-sm text-gray-500 dark:text-neutral-500">{item.description}</span>
                      </div>
                    </td>
                    <td className="h-px w-72 whitespace-nowrap">
                      <div className="px-6 py-3">
                        {/* <span className="block text-sm font-semibold text-gray-800 dark:text-neutral-200">{item.}</span> */}
                        <span className="block text-sm text-gray-500 dark:text-neutral-500">{item.alias}</span>
                      </div>
                    </td>
                    <td className="size-px whitespace-nowrap">
                      <div className="px-6 py-3">
                    ...
                    <td className="size-px whitespace-nowrap">
                      <div className="px-6 py-3">
                        <div className="flex items-center gap-x-3">
                          <span className="text-xs text-gray-500 dark:text-neutral-500">{item.category}</span>
